...
import co.aspirasoft.sams.storage.FileUtils.getLastPathSegmentOnly
import co.aspirasoft.sams.storage.MaterialAdapter
import co.aspirasoft.sams.view.AddLectureDialog
import co.aspirasoft.sams.view.LectureView
...
class SubjectActivity : DashboardChildActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editable = intent.getBooleanExtra(MyApplication.EXTRA_EDITABLE_MODE, editable)
        if (editable) {
