...
import co.aspirasoft.sams.model.Test
...
class ReportCardActivity : DashboardChildActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        subjects = intent.getStringArrayListExtra(MyApplication.EXTRA_SCHOOL_SUBJECT) ?: return finish()
        classId = intent.getStringExtra(MyApplication.EXTRA_STUDENT_CLASS_ID) ?: return finish()
    }
